...
class TestContentCommands(BaseCliTest):
    ...
    def test_generate_content(self):
        ...
        self.generator_instance.generate_post.return_value = "Generated test content"
        ...
        self.assertIn("Generated test content", result.output)
        self.generator_instance.generate_post.assert_called_once_with(
            "Test prompt", max_length=None, tone="casual"
        )
